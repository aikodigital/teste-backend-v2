...
namespace teste_backend_v2.Controllers
{
    ...
    public class EquipmentsController : Controller
    {
        ...
        #region Equipment Model State Hourly Earnings

        // O crud para essa funcionalidade não pôde ser feito, pois está faltando uma chave primária na tabela Equipment_model_state_hourly_earnings

        #region List Equipment Model State Earnings

        //[Route("/[controller]/Earnings/List")]
        //public IActionResult ListEquipmentHourlyEarnings()
        //{
        //    var equipmentsEarnings = db.EquipmentModelStateHourlyEarnings;
        //    var listEquipmentsEarnings = equipmentsEarnings.Select(x => new ListEquipmentHourlyEarningsViewModel
        //    {               
        //        EquipmentModelId = x.EquipmentModel.Id,
        //        EquipmentStateId = x.EquipmentState.Id,
        //        EquipmentModel = x.EquipmentModel.Name,
        //        EquipmentState = x.EquipmentState.Name,
        //        Value = x.Value.ToString()
        //    });
        //
        //    return View("~/Views/EquipmentHourlyEarnings/ListEquipmentHourlyEarnings.cshtml", listEquipmentsEarnings);
        //}

        #endregion List Equipment Model State Earnings

        #region  Include Equipment Model State Earnings

        //[Route("/[controller]/Earnings/Include")]
        //[HttpGet]
        //public IActionResult IncludeEquipmentHourlyEarnings()
        //{
        //    IncludeEquipmentHourlyEarningsViewModel model = new IncludeEquipmentHourlyEarningsViewModel();
        //    model.SetValuesDropdown(db);
        //    return View("~/Views/EquipmentHourlyEarnings/IncludeEquipmentHourlyEarnings.cshtml", model);
        //}
        //
        //[Route("/[controller]/Earnings/Include")]
        //[HttpPost]
        //public IActionResult IncludeEquipmentHourlyEarnings(IncludeEquipmentHourlyEarningsViewModel model)
        //{
        //
        //    var error = model.ValidateData(this, db);
        //    if (error != null) return error;
        ...
        //            try
        //            {
        //                EquipmentModelStateHourlyEarning equipmentEarnings = new EquipmentModelStateHourlyEarning()
        //                {                            
        //                    Value = model.Value == null ? 0 : model.Value,
        //                    EquipmentModelId = model.EquipmentModelId,
        //                    EquipmentStateId = model.EquipmentStateId
        //                };
        //
        //                db.EquipmentModelStateHourlyEarnings.Add(equipmentEarnings);
        //                db.SaveChanges();
        //                transation.Commit();
        //
        //                //return Json(new { success = true, message = "Equipment Earnings has been included!" });
        //                return RedirectToAction(nameof(ListEquipmentHourlyEarnings));
        //            }
        //            catch (Exception e)
        //            {
        //                logger.LogError(e, e.Message);
        ...
        #endregion Include Equipment Model State Earnings

        #region Update Equipment Model State Earnings

        //[Route("/[controller]/Earnings/Update")]
        //[HttpGet]
        //public IActionResult UpdateEquipmentHourlyEarnings(Guid idEquipmentModel, Guid idEquipmentState, string value)
        //{
        //    if (idEquipmentModel == null || idEquipmentState == null || value == null)
        //    {
        //        return NotFound();
        //    }
        //
        //    UpdateEquipmentHourlyEarningsViewModel model = new UpdateEquipmentHourlyEarningsViewModel();
        //    model.EquipmentModelId = idEquipmentModel;
        //    model.EquipmentStateId = idEquipmentState;
        //    model.ValueMask = value;
        //
        //    model.SetValuesDropdown(db);
        //    var error = model.LoadingData(this, db);
        //    if (error != null)
        ...
        //    }
        //
        //    return View("~/Views/EquipmentHourlyEarnings/UpdateEquipmentHourlyEarnings.cshtml", model);
        //}
        //
        //[Route("/[controller]/Earnings/Update")]
        //[HttpPost]
        //public IActionResult UpdateEquipmentHourlyEarnings(UpdateEquipmentHourlyEarningsViewModel model)
        //{
        //
        //    var error = model.ValidateData(this, db);
        //    if (error != null) return error;
        ...
        //            try
        //            {
        //                var earning = db.EquipmentModelStateHourlyEarnings.FirstOrDefault(x => x.EquipmentModelId == model.EquipmentModelId && x.EquipmentStateId == model.EquipmentStateId);
        //                earning.Value = model.Value;
        //                earning.EquipmentModelId = model.EquipmentModelId;
        //                earning.EquipmentStateId = model.EquipmentStateId;
        //
        //                db.SaveChanges();
        //                transation.Commit();
        //                //return Json(new { success = true, message = "Earning has been updated!" });
        //                return RedirectToAction(nameof(ListEquipmentHourlyEarnings));
        //            }
        //            catch (Exception e)
        //            {
        ...
        #endregion Update Equipment Model State Earnings

        #endregion Equipment Model State Hourly Earnings
